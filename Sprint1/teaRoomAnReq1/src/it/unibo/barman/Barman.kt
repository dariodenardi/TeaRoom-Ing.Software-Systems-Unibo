		...
		return { //this:ActionBasciFsm
				...
				state("waitOrder") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t010",targetState="prepareOrder",cond=whenDispatch("waiterOrderForward"))
					transition(edgeName="t011",targetState="endState",cond=whenDispatch("end"))
				}	 
				state("prepareOrder") { //this:State
					action { //it:State
						...
						if( checkMsgContent( Term.createTerm("waiterOrderForward(ID,ORDER)"), Term.createTerm("waiterOrderForward(ID,ORDER)"), 
								...
								forward("barmanOrderReady", "barmanOrderReady(${payloadArg(0)})" ,"waiter" ) 
						}
					}
					 transition( edgeName="goto",targetState="waitOrder", cond=doswitch() )
				}	 

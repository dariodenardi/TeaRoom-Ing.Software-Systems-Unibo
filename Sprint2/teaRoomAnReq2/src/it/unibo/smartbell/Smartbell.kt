		...
		return { //this:ActionBasciFsm
				...
				state("waitRing") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t044",targetState="checkTempClient",cond=whenRequest("clientRingEntryRequest"))
					transition(edgeName="t045",targetState="endState",cond=whenDispatch("end"))
				}	 
				state("checkTempClient") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t146",targetState="checkWaiterReply",cond=whenReply("smartbellEntryReply"))
					transition(edgeName="t147",targetState="clientRejected",cond=whenDispatch("smartbellClientRejected"))
				}	 
